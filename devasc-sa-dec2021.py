...
#######################################################################################
# Instruction
# 1. Complete all 12 tasks by adding code to all <!!!REPLACEME!!!!> in this file.
# 1. Append yourname to this file name (e.g. devasc-sa-dec2021-chotipat.py)
# 2. Send (attach) this file to chotipat@it.kmitl.ac.th by 17:00.
#######################################################################################
# This program:
